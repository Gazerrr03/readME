export const dictionaries = Object.freeze({
  en: Object.freeze({
    ...
    'photos.previous': 'Previous photo', 'photos.next': 'Next photo', 'photos.prevLabel': 'PREV', 'photos.nextLabel': 'NEXT',
    ...
    'desktop.secure': 'SECURE', 'desktop.open': 'OPEN', 'desktop.dock': 'Dock',
    'bot.label': 'BOT', 'bot.standby': 'BOT SERVICE: STANDBY', 'protocol.build': 'BUILD: 882.A',
  ...
  'zh-CN': Object.freeze({
    ...
    'photos.previous': '上一张', 'photos.next': '下一张', 'photos.prevLabel': '上一张', 'photos.nextLabel': '下一张',
    'player.previous': '上一曲',
    ...
    'desktop.secure': '加密', 'desktop.open': '开放', 'desktop.dock': '程序坞',
    'bot.label': 'BOT', 'bot.standby': 'BOT 服务：待机', 'protocol.build': 'BUILD: 882.A',
    'language.en': 'EN', 'language.zh': '中文', 'language.ja': '日本語',
  ...
  ja: Object.freeze({
    ...
    'photos.previous': '前の写真', 'photos.next': '次の写真', 'photos.prevLabel': '前へ', 'photos.nextLabel': '次へ',
    'player.previous': '前の曲',
    ...
    'desktop.secure': '暗号化', 'desktop.open': 'オープン', 'desktop.dock': 'Dock',
    'bot.label': 'BOT', 'bot.standby': 'BOTサービス：待機中', 'protocol.build': 'BUILD: 882.A',
    'language.en': 'EN', 'language.zh': '中文', 'language.ja': '日本語',
