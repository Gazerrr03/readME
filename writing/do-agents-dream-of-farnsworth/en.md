...
Field notes: Field notes: the software-engineering material is from Fred Brooks's The Mythical Man-Month (1975 / 1995); "less is more" and "God is in the details" are attributed to Mies van der Rohe; the passage on unused Skills was triggered by kinomotomio's "Sediment and Seed". The reading of Reims Cathedral is my own.
